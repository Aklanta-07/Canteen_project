...
<head>
    ...
    <style>
        * {
        ...
        .icon-breakfast { background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%); }
        .icon-lunch { background: linear-gradient(135deg, #DBEAFE 0%, #BFDBFE 100%); }
        .icon-dinner { background: linear-gradient(135deg, #FECACA 0%, #FCA5A5 100%); }
        .icon-snacks { background: linear-gradient(135deg, #D1FAE5 0%, #A7F3D0 100%); }
        ...
        .time-breakfast { background: #FEF3C7; color: #92400E; }
        .time-lunch { background: #DBEAFE; color: #1E40AF; }
        .time-dinner { background: #FECACA; color: #991B1B; }
        .time-snacks { background: #D1FAE5; color: #065F46; }
...
<body>
                ...
                <c:choose>
                    <c:when test="${empty menuItems}">
                        ...
                        <div class="empty-state">
                            ...
                            <p class="empty-text">Sorry, there are no menu items available today. Please check back later!</p>
                        </div>
                    </c:when>
                    <c:otherwise>
                        <!-- Menu Grid -->
                        <div class="menu-grid">
                            <c:forEach var="item" items="${menuItems}" varStatus="status">
                                <div class="menu-card">
                                    ...
                                    <div class="card-price">₹<fmt:formatNumber value="${item.price}" pattern="#,##0" /></div>
                                    ...
                                    <div class="quantity-control">
                                        ...
                                        <button class="qty-btn" 
                                                ...
                                                data-name="${item.itemName}">+</button>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
    ...
    <script>
        ...
        function confirmOrder() {
            ...
            // TODO: You will add your backend servlet call here
            const total = document.getElementById('total').textContent;
            alert('Order confirmed!\\n\\nTotal Amount: ' + total + '\\n\\nReady for backend integration!');
            
            // When you're ready to connect to backend, uncomment and modify:
            /*
            const orderData = {
                items: cart,
            ...
            // Submit to your servlet
            window.location.href = 'OrderServlet?action=placeOrder';
            // OR use AJAX to post the order data
            */
        }
